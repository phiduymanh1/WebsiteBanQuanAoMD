...
VALUES
    (N'Áo thun basic', N'Áo thun cổ tròn chất liệu cotton', 300000, 1, N'ao_phong_trang.jpg'),
    (N'Quần jeans nam', N'Quần jeans nam ống đứng', 600000, 2, N'quan_jeans_nam.jpg'),
...
VALUES
    ...
    (1, 1, 1, 5, 50, N'aoThunDo.jpg'), -- Đỏ, size S
    (1, 1, 2, 5, 50, N'aoThunDo.jpg'), -- Đỏ, size M
    (1, 2, 1, 5, 50, N'AoThunXanh.jpg'), -- Xanh, size S
    (1, 2, 2, 5, 50, N'AoThunXanh.jpg'), -- Xanh, size M

    -- Sản phẩm 2: Quần jeans nam
    (2, 3, 3, 1, 30, N'quan_jeans_nam.jpg'), -- Đen, size L
    (2, 3, 4, 1, 30, N'quan_jeans_nam.jpg'), -- Đen, size XL
    (2, 4, 3, 1, 30, N'quan_jeans_nam.jpg'), -- Trắng, size L
    (2, 4, 4, 1, 30, N'quan_jeans_nam.jpg'), -- Trắng, size XL

    -- Sản phẩm 3: Váy maxi nữ
    (3, 1, 1, 2, 40, N'vaymaxi.jpg'), -- Đỏ, size S
    (3, 1, 2, 2, 40, N'vaymaxi.jpg'), -- Đỏ, size M
    (3, 2, 1, 2, 40, N'vaymaxi.jpg'), -- Xanh, size S
    (3, 2, 2, 2, 40, N'vaymaxi.jpg'), -- Xanh, size M
    ...
    (5, 4, 1, 4, 70, N'nonbucket.jpg'), -- Trắng, size S
    (5, 4, 2, 4, 70, N'nonbucket.jpg'), -- Trắng, size M
    (5, 5, 1, 4, 70, N'nonbucket.jpg'), -- Be, size S
    (5, 5, 2, 4, 70, N'nonbucket.jpg'); -- Be, size M
